...
export class QuestionTagListQueryDto {
  ...
  @ApiPropertyOptional({ enum: QUESTION_TAG_SORT_FIELDS, default: 'createdAt' })
  @IsOptional()
  @IsIn([...QUESTION_TAG_SORT_FIELDS])
  sortBy: (typeof QUESTION_TAG_SORT_FIELDS)[number] = 'createdAt';

  @ApiPropertyOptional({ enum: QUESTION_TAG_SORT_DIRECTIONS, default: 'ASC' })
  @IsOptional()
  @IsIn([...QUESTION_TAG_SORT_DIRECTIONS])
  sort: (typeof QUESTION_TAG_SORT_DIRECTIONS)[number] = 'ASC';

  @ApiPropertyOptional({ enum: QuestionTagStatus })
  @IsOptional()
  @IsEnum(QuestionTagStatus)
  status?: QuestionTagStatus;

  @ApiPropertyOptional({ description: 'Case-insensitive search across tag code and name.' })
  @IsOptional()
  @IsString()
  @MaxLength(128)
  search?: string;
