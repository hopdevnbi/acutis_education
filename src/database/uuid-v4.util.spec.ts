import { generateUuidV4, isUuidV4, normalizeUuid } from './uuid-v4.util';
...
describe('uuid-v4.util', () => {
  ...
  it('normalizes UUID strings to lowercase', () => {
    expect(normalizeUuid('0B978DB3-BB27-4AF2-AFF9-0931DD297DC2')).toBe(
      '0b978db3-bb27-4af2-aff9-0931dd297dc2',
    );
  });
});
